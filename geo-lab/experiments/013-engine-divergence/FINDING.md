...
Record-level agreement between the two methods: **68.0%**. Both methods show the effect in the **same direction** — the result is not a verbatim-quotability artifact.
