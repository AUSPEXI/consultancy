...
Record-level agreement between the two methods: **71.9%**. Both methods show the effect in the **same direction** — the result is not a verbatim-quotability artifact.
