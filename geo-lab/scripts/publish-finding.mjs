...
const LEVER_GUIDANCE = {
  ...
  'active-voice':              { headline: 'Use active voice',                         guidance: 'Active constructions ("L8EntSpace reduces…") are cited more than passive ("…is reduced by L8EntSpace").', appliesTo: ['style'] },
