...
const ALL_FAQS = [
  ...
  { question: "Is my data secure with Auspexi?", answer: "Yes. Your data is encrypted at rest (AES-256) and in transit (TLS 1.3) via Google Cloud infrastructure — the same stack trusted by Fortune 500 companies globally. We enforce strict role-based access control (RBAC), isolated multi-tenant vector namespaces, and PII masking at the collection layer. SOC 2 Type II certification is on our security roadmap as we scale toward enterprise contracts." },
