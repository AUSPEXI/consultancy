        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="prose prose-invert prose-zinc max-w-none text-sm leading-relaxed text-zinc-350 space-y-8 font-sans">
            <section className="mb-10">
              <h2 className="text-2xl font-semibold mb-4 text-white font-heading">1. Introduction</h2>
              <p>Welcome to Auspexi. We respect your privacy and are committed to protecting your personal data. This Privacy Policy will inform you as to how we look after your personal data when you visit our website and tell you about your privacy rights and how the law protects you, particularly in compliance with the General Data Protection Regulation (GDPR).</p>
            </section>
            <section className="mb-10">
              <h2 className="text-2xl font-semibold mb-4 text-white font-heading">2. The Data We Collect About You</h2>
            ...
            <section className="mb-10">
              <h2 className="text-2xl font-semibold mb-4 text-white font-heading">3. How We Use Your Personal Data</h2>
            ...
            <section className="mb-10">
              <h2 className="text-2xl font-semibold mb-4 text-white font-heading">4. Cookie Policy</h2>
              <p className="mb-4">Our website uses cookies to distinguish you from other users of our website. This helps us to provide you with a good experience when you browse our website and also allows us to improve our site.</p>
              <h3 className="text-xl font-medium mb-3 text-white font-heading">What cookies do we use?</h3>
              <ul className="list-disc pl-6 space-y-2 mb-4">
            ...
            <section className="mb-10">
              <h2 className="text-2xl font-semibold mb-4 text-white font-heading">5. Your Legal Rights (GDPR)</h2>
